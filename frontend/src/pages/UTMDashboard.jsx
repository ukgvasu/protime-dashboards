    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-2">
        ...
        <div className="grid grid-cols-5 gap-4 mb-6">
          <StatCard label="Internal Only" value={stats.internalOnly} sublabel="No customer impact" color="#0d9488" />
          ...
          <StatCard label="Total Open" value={stats.total} sublabel="All open defects" color="#0d9488" />
        </div>
      </div>
