...
const COLORS = ['#0d9488', '#3AD6C5', '#b7950b', '#dc2626', '#7c3aed', '#ea580c', '#16a34a', '#3b82f6'];
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        ...
        <StatCard label="Unassigned" value={stats.unassigned} sublabel="Needs owner" color="#6b7280" />
      </div>
