...
const COLORS = ['#b7950b', '#005151', '#3AD6C5', '#dc2626', '#7c3aed', '#ea580c', '#16a34a', '#3b82f6', '#f59e0b'];
    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
      ...
      >
        ...
        <div className="flex items-center gap-2">
          {count != null && (
            <span className="bg-[#b7950b] text-white text-xs px-2 py-0.5 rounded-full">{count}</span>
          )}
          {open
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="space-y-3">
        ...
        <CollapsibleSection title="Security Vulnerabilities" count={null}>
          <p className="text-sm text-gray-400 italic">Security defects — see the <a href="/security" className="text-[#b7950b] underline">Security dashboard</a>.</p>
        </CollapsibleSection>
      </div>
    </div>
  );
