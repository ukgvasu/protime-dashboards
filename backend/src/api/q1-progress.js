...
// GET /api/q1-progress/:product - Get Q1 Development Progress Epics
router.get('/:product', async (req, res) => {
  try {
    ...
    const cacheKey = `q1-progress:${product}`;
    ...
    console.log(`[q1-progress/${product}] Found ${issues.length} Epics`);
    ...
    console.error(`[q1-progress/${req.params.product}] error:`, err.message);
